...
// context API helps sharing state down a component tree. 
// can connect to any state.
// can connect multiple context to different parts of the app.

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

// reducers provides immutable, pure, single source of data and no prop drilling needed.
// store holds the whole state tree of your application.
// action carries a payload of information from your application to the store.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?
// redux-thunk allows us access to the dispatch function in our action creators.

4. What is your favorite state management system you've learned and this sprint? Please explain why!
// redux is my favorite state management because it avoids prop drilling and 
